...
/*	ZEND_FE( magickconvolveimagechannel, NULL )  */
	...
	ZEND_FE( magickidentifyimage, NULL )

	ZEND_FE( magickdespeckleimage, NULL )

	ZEND_FE( magickdisplayimage, NULL )
	ZEND_FE( magickdisplayimages, NULL )
...
/*	ZEND_FE( magickgaussianblurimagechannel, NULL )  */
	...
	ZEND_FE( magickgetcompression, NULL )
	ZEND_FE( magickgetcompressionquality, NULL )
...
//	ZEND_FE( magickgetimagechannelstatistics, NULL )
...
/*	ZEND_FE( magickgetimagechanneldistortion, NULL )	*/
	...
	ZEND_FE( magickgetimageattribute, NULL )
...
/*	ZEND_FE( magickgetimagechannelextrema, NULL )  */
	...
	ZEND_FE( magickgetimagepage, NULL )

	ZEND_FE( magickgetimagepixelcolor, NULL )

	ZEND_FE( magickgetimagepixels, NULL )
	ZEND_FE( magickgetimageprofile, NULL )
	ZEND_FE( magickgetimageproperty, NULL )
	ZEND_FE( magickgetimageredprimary, NULL )

	ZEND_FE( magickgetimageregion, NULL )
	...
	ZEND_FE( magickgetimagetickspersecond, NULL )

	ZEND_FE( magickgetimagetotalinkdensity, NULL )
	...
	ZEND_FE( magickgetoption, NULL )

	ZEND_FE( magickgetpackagename, NULL )

	ZEND_FE( magickgetpage, NULL )

	ZEND_FE( magickgetquantumdepth, NULL )

	ZEND_FE( magickgetquantumrange, NULL )

	ZEND_FE( magickgetreleasedate, NULL )

	ZEND_FE( magickgetresource, NULL )
...
/*	ZEND_FE( magicknegateimagechannel, NULL )  */
	...
	ZEND_FE( magickfloodfillpaintimage, NULL )
	ZEND_FE( magickopaquepaintimage, NULL )
	ZEND_FE( magicktransparentpaintimage, NULL )
...
/* end of convenience functions */
	...
	ZEND_FE( magickresetimagepage, NULL )
	...
	ZEND_FE( magicksepiatoneimage, NULL )

	ZEND_FE( magicksetbackgroundcolor, NULL )

	ZEND_FE( magicksetcompression, NULL )
	...
	ZEND_FE( magicksetimagealphachannel, NULL )
	ZEND_FE( magicksetimageattribute, NULL )
...
/*	ZEND_FE( magicksetimagechanneldepth, NULL )  */
	...
	ZEND_FE( magicksetimageextent, NULL )
	...
	ZEND_FE( magicksetimageproperty, NULL )
	...
	ZEND_FE( magicksetimagetickspersecond, NULL )
	...
	ZEND_FE( magicksetoption, NULL )

	ZEND_FE( magicksetpage, NULL )
...
/*	ZEND_FE( magickthresholdimagechannel, NULL ) */
	...
	ZEND_FE( magickthumbnailimage, NULL )
...
/*	ZEND_FE( magickunsharpmaskimagechannel, NULL ) */
	...
	ZEND_FE( pixelgetpreviousiteratorrow, NULL )

	ZEND_FE( pixelresetiterator, NULL )

	ZEND_FE( pixelsetfirstiteratorrow, NULL )

	ZEND_FE( pixelsetiteratorrow, NULL )

	ZEND_FE( pixelsetlastiteratorrow, NULL )
...
/*	ZEND_FE( destroypixelwands, NULL ) */
	...
	ZEND_FE( ispixelwandsimilar, NULL )
...
*/
ZEND_FUNCTION( magickopaquepaintimage )
{
	MW_PRINT_DEBUG_INFO
...
*/
ZEND_FUNCTION( magicktransparentpaintimage )
{
	MW_PRINT_DEBUG_INFO
